...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert('Login functionality will be implemented with Supabase integration.');
    }, 1000);
  };
      ...
      <main className="max-w-md mx-auto px-4 py-16">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[var(--leica-orange)] focus:ring-[var(--leica-orange)]" />
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 h-11 border border-gray-300 rounded hover:bg-gray-50 transition-colors">
